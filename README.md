...
Project Overview
This interactive web application was developed to help HR departments identify the main drivers behind employee turnover. By leveraging Python and Streamlit, the dashboard transforms raw HR data into actionable insights, focusing on the correlation between Professional Development (Training Hours) and Talent Retention rates.
...
1. Select Departments: Use the sidebar to focus on specific areas of the company.


2. Analyze Trends: Observe the box plots to see the distribution of training hours among employees who left vs. those who stayed.


3. Implement Strategies: Use the metrics to justify budget allocation for professional development programs.
